...
Se você tem feedback sobre este workshop ou quer se envolver com a comunidade:  
...
Este repositório do workshop é **open source** sob a [licença CC-BY-NC 4.0](./LICENSE_CC-BY-NC-4.0.md).  
Contribuições, issues e estrelas são bem-vindas em:  
